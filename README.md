...
|--------------|-----------------|-----------------|---------------|---------------|----------|-----------------|
|  master      |   >0.8.2,<0.9   |  >=0.3.4,<0.4   | >=0.3,<0.4    | ~1.8.1        | `~4.2.1` | >=1.4.1,<2.0    |
|  0.0.8       |   >0.8.2,<0.9   |  >=0.3.4,<0.4   | >=0.3,<0.4    | ~1.8.1        | `~4.2.1` | >=1.4.1,<2.0    |
|  0.0.7       |   >0.8.0,<0.9   |  >=0.3.4,<0.4   | >=0.3,<0.4    | ~1.8.1        | `~4.2.1` | >=1.4.1,<2.0    |
|  0.0.6       |   >0.6.0,<0.8   |  >=0.2.2,<0.3   | >=0.3,<0.4    | ~1.8.1        | `~4.2.1` | >=1.4.1,<2.0    |
