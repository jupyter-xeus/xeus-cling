...
namespace xcpp
{
	...
	llvm::SmallVector<llvm::Optional<llvm::StringRef>, 16 > Redirects;
	Redirects.push_back(llvm::NoneType::None);
	Redirects.push_back(OutputFileStr);
	Redirects.push_back(ErrorFileStr);
